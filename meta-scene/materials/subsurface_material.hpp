...
namespace metascene {
	...
	namespace materials {
		...
		struct subsurface_material final : material {
			...
			std::shared_ptr<texture> sigma_a = std::make_shared<constant_texture>(value_type::spectrum);
			std::shared_ptr<texture> sigma_s = std::make_shared<constant_texture>(value_type::spectrum);
