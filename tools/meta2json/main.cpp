...
int main()
{
	//const auto scene = meta_scene::importers::pbrt::import_pbrt_scene("./../../resources/cornell-box/scene-v4.pbrt");
	...
	//const auto scene = meta_scene::importers::pbrt::import_pbrt_scene("./../../resources/veach-mis/scene-v4.pbrt");
	//const auto scene = meta_scene::importers::pbrt::import_pbrt_scene("./../../resources/dragon/scene-v4.pbrt");
	//const auto scene = meta_scene::importers::pbrt::import_pbrt_scene("./../../resources/coffee/scene.pbrt");
	...
	//meta_scene::exporters::json::export_scene_to_file(scene, "./../../resources/veach-mis/scene.json");
